...
Go to `src/Forminer/components/ExpressionBuilder/Expression.tsx` file and change `Expression` function name to any other, for example, `Expression2`.
...
Go to `src/Forminer/components/uniforms/index.ts` file and change the file as follows:
