...
const cards = [
  {
    ...
    description: `Use the ready-made solution to address your project needs instead of wasting your time & budget to build on your own.`
  },
  {
...
export const FormRelatedIssues = () => {
  return (
    <SectionLayout heading="Take form-related issues off your mind" centerHeading id={id}>
