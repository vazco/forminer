...
const cards = [
  {
    ...
    description: `Build custom forms by arranging the components as you prefer.`
  },
  {
    icon: <ValidationIcon />,
  ...
  },
  {
    ...
    description: `Enjoy Forminer's lightness and see how your code changes impact forms in real time.`
  }
];

export const PowerfulFeatures = () => {
  return (
    <SectionLayout heading="What makes our form builder so powerful?" centerHeading id={id}>
