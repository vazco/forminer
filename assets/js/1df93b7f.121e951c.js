...
`,l=n.css`
  ${r}
  ${i}
`},4242:(e,t,a)=>{a.r(t),a.d(t,{default:()=>wa});var n=a(9960),r=a(7294),i=a(3457),l=a(7379),o=a(4968),s=a(8770),m=a(7704);const c=(0,a(605).Jq)({xs:"0",sm:"576px",md:"768px",lg:"1024px",xl:"1360px",xxl:"1920px"}),d=l.css`
...
`,x=l.css`
  ...
  `}
`,h=(0,o.Z)({breakpoints:{values:{xs:0,sm:576,md:768,lg:1024,xl:1360}},palette:{primary:{main:"#1074ef"}}}),u={color:{primary:"#1074ef",darkBlue:"#0d5dbf",body:"#000000",grey:"#fafafb",darkGrey:"#f4f5f6",white:"#fff"}},k=l.createGlobalStyle`
${m.Fv}
html {
...
`,f=e=>{let{children:t}=e;return r.createElement(i.Z,{theme:h},r.createElement(k,null),r.createElement(l.ThemeProvider,{theme:u},r.createElement("main",null,t)))};var g=a(5742);const y=JSON.parse('{"TN":"Forminer | Build Forms in React the way you need","WL":"Check how Forminer can solve your issues with forms in React. Enjoy your saved time by using conditional field validation, WYSIWYG form editor and more straight from the start and take your business to another level.","vu":"index, follow"}'),E=()=>r.createElement(g.Z,null,r.createElement("title",null,y.TN),r.createElement("meta",{name:"description",content:y.WL}),r.createElement("meta",{property:"robots",content:y.vu}));var b=a(8920),A=a(1437),v=a(1749);const w=l.default.div`
  max-width: 1360px;
  margin: 0 auto;
  ${c.lessThan("xl")`
    padding-left: 16px;
    padding-right: 16px;
  `}
`,B=e=>{let{children:t,id:a,className:n,wide:i=!1}=e;return r.createElement(w,{id:a,className:n,wide:i},t)};var G=a(3192);const D=l.default.section`
  padding: 10px;
  display: flex;
  align-items: center;
...
`,j=l.default.img`
  max-width: 100%;
  height: auto;
`,z="#0d5dbf",Z=e=>{let{children:t}=e;const a=(0,b.Z)(),n=(0,A.Z)(a.breakpoints.up("md")),i=(0,A.Z)(a.breakpoints.up("lg"));return r.createElement(D,{bgColor:z},r.createElement(V,{bgColor:z},r.createElement(T,{direction:"row-reverse",alignItems:"start",container:!0},!i&&r.createElement(v.Z,{xs:12,sm:12,md:12,lg:6,item:!0},r.createElement(O,{reversed:!0},t)),n&&r.createElement(S,{xs:12,sm:12,md:12,lg:6,item:!0},r.createElement(j,{src:G.default,alt:"Forminer - Build form in React without any problems"})),i&&r.createElement(v.Z,{xs:12,sm:12,md:12,lg:6,item:!0},r.createElement(O,{reversed:!0},t)))))};var P=a(308),F=a.n(P);const I=l.css`
  padding: 0;
  border: none;
  outline: none;
  font: inherit;
...
`,M=l.css`
  ...
  ${e=>{let{theme:t,variant:a,reversed:n}=e;return n&&"solid"===a?l.css`
...
`,L=l.default.button`
  ${I}
  ${M}
`,K=e=>{let{children:t,className:a,disabled:n=!1,onClick:i=F(),reversed:l=!1,size:o="md",type:s="button",variant:m="solid"}=e;return r.createElement(L,{className:a,disabled:n,onClick:i,reversed:l,size:o,type:s,variant:m},t)};var Q;function Y(){return Y=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},Y.apply(this,arguments)}const N=e=>{let{title:t,titleId:a,...n}=e;return r.createElement("svg",Y({xmlns:"http://www.w3.org/2000/svg",width:39,height:39,viewBox:"0 0 39 39",role:"img","aria-labelledby":a},n),t?r.createElement("title",{id:a},t):null,Q||(Q=r.createElement("g",{fill:"none",transform:"translate(2 2)"},r.createElement("ellipse",{cx:17.723,cy:17.723,stroke:"#1074EF",strokeWidth:3,rx:17.723,ry:17.711}),r.createElement("path",{fill:"#1074EF",d:"m16.302 27.144-8.38-6.528 2.383-3.058 5.146 4.009 8.492-12.255 3.187 2.207z"}))))};var H;function R(){return R=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},R.apply(this,arguments)}const C=e=>{let{title:t,titleId:a,...n}=e;return r.createElement("svg",R({xmlns:"http://www.w3.org/2000/svg",width:39,height:39,viewBox:"0 0 39 39",role:"img","aria-labelledby":a},n),t?r.createElement("title",{id:a},t):null,H||(H=r.createElement("g",{fill:"none",transform:"translate(2 2)"},r.createElement("ellipse",{cx:17.723,cy:17.723,stroke:"#fff",strokeWidth:3,rx:17.723,ry:17.711}),r.createElement("path",{fill:"#fff",d:"m16.302 27.144-8.38-6.528 2.383-3.058 5.146 4.009 8.492-12.255 3.187 2.207z"}))))},W=l.default.ul`
...
`,J=e=>{let{children:t,theme:a}=e;return r.createElement(X,{theme:a},"white"===a?r.createElement(q,null):r.createElement(U,null),t)},$=e=>{let{children:t}=e;return r.createElement(W,null,t)},_=e=>{let{to:t,children:a,internal:i=!1,newTab:l=!0}=e;return i?r.createElement(n.Z,{to:t},a):r.createElement("a",{href:t,target:l?"_blank":"_self",rel:l?"noopener noreferrer":""},a)},ee=l.default.div`
  display: grid;
  justify-items: start;
  align-items: center;
...
`}
  ...
  ${c.greaterThan("md")`
    margin-top: ${(0,s.hO)("40px")};
  `}
`,me=e=>{e.preventDefault();const t=document.getElementById("pricing");t&&t.scrollIntoView()},ce=()=>{const e=(0,b.Z)(),t=(0,A.Z)(e.breakpoints.down("xs"));return r.createElement(Z,null,r.createElement("h1",{style:{color:"white",fontWeight:600}},"Forminer"),r.createElement(oe,null,r.createElement("strong",null,"Save up to 1500 hours")," while building form-heavy React apps with our easy to integrate package"),r.createElement($,null,r.createElement(J,{theme:"white"},r.createElement("span",null,r.createElement("strong",null,"Powerful solution")," - custom fields, full state machine, conditional fields, schema-first approach, and many more...")),r.createElement(J,{theme:"white"},r.createElement("span",null,r.createElement("strong",null,"Traffic-independent payment")," - pick a one-time payment or subscription, not based on the number of users")),r.createElement(J,{theme:"white"},r.createElement("span",null,r.createElement("strong",null,"Good support")," - basing on our popular OpenSource package, uniforms, guarantees no vendor locking"))),!t&&r.createElement(r.Fragment,null,r.createElement(se,null,"Supported design libraries:"),r.createElement(ie,null)),r.createElement(le,null,r.createElement(K,{onClick:me,size:"lg"},"Check pricing"),r.createElement(_,{to:"/docs",internal:!0},r.createElement(K,{variant:"outlined",size:"lg"},"See technical documentation"))),t&&r.createElement(r.Fragment,null,r.createElement(se,null,"Supported design libraries:"),r.createElement(ie,null)))},de=l.default.li`
  &:not(:last-child) {
    margin-bottom: ${(0,s.hO)("8px")};
  }
`,pe=l.default.ul`
  padding-left: 50px;
`,xe=e=>{let{children:t}=e;return r.createElement(de,null,t)},he=e=>{let{children:t}=e;return r.createElement(pe,null,t)},ue=l.default.div`
...
`,ke=(0,l.default)(ue)`
  ...
  ${c.greaterThan("md")`
    ...
    padding-bottom: 75px;
  `}
`,fe=e=>{let{children:t,id:a,alternativeBackground:n}=e;return r.createElement(ke,{id:a,alternativeBackground:n,as:"section"},t)},ge=l.default.h2`
  ...
  ${e=>{let{size:t}=e;switch(t){case"xl":return d;case"lg":return p;case"md":return x;default:return l.css`
          ...
          line-height: inherit;
        `}}}
`,ye=e=>{let{children:t,level:a=3,size:n="md",isStrong:i=!0,marginBottom:l}=e;return r.createElement(ge,{isStrong:i,as:`h${a}`,size:n,marginBottom:l},t)},Ee=l.default.div`
  display: flex;
...
`,be=(0,l.default)(ye)`
  max-width: 660px;
  font-weight: 300;
`,Ae=e=>{let{children:t,level:a=3,size:n="md",isStrong:i=!0}=e;return r.createElement(Ee,null,r.createElement(be,{level:a,size:n,isStrong:i},t))},ve=e=>{let{children:t,heading:a,alternativeBackground:n=!1,id:i}=e;return r.createElement(fe,{alternativeBackground:n,id:i},r.createElement(B,null,a&&r.createElement(Ae,{isStrong:!0},a),t))};var we=a(1248),Be=a.n(we),Ge=a(1216);const De=l.default.div`
  width: 100%;
  display: flex;
  align-items: center;
  justify-content: center;
  ...
  ${c.greaterThan("md")`
    ...
    position: relative;
  `}
`,Ve=e=>{let{data:t}=e;const a=(0,r.useRef)(null);return(0,r.useEffect)((()=>{let e;if(a.current){const n=JSON.parse(t);e=Be().loadAnimation({animationData:n,container:a.current,loop:!0,renderer:"svg"})}return()=>{e.destroy()}}),[t,a]),r.createElement("div",{ref:a})},Se=(0,l.default)(De)`
  ${c.greaterThan("md")`
    min-height: 600px;
  `}
`,Oe=l.default.div`
  width: 100%;
`;var Te=a(5477);const je=l.default.div`
  width: 100%;
  min-height: 200px;
  height: 100%;
  display: flex;
  ...
  ${c.greaterThan("md")`
    min-height: 400px;
  `}
`,ze=()=>r.createElement(je,null,r.createElement(Te.Z,null)),Ze=(0,r.lazy)((()=>Promise.all([a.e(655),a.e(307)]).then(a.bind(a,307)))),Pe=(0,l.default)(De)`
  ${c.greaterThan("md")`
    min-height: 600px;
  `}
`,Fe=l.default.div`
...
`,Ke=l.default.div`
  ...
  ${c.greaterThan("md")`
    ...
    padding-top: 58px;
    padding-bottom: 58px;
    ${e=>{let{isReversed:t}=e;return t?l.css`
            padding-right: 0;
            padding-left: 116px;
          `:l.css`
            padding-left: 0;
...
`,Qe={animation:e=>{let{data:t}=e;return r.createElement(Se,null,r.createElement(Oe,null,r.createElement(Ge.ZP,{offset:1200,once:!0},r.createElement(Ve,{data:t}))))},video:e=>{let{data:t}=e;return r.createElement(Pe,null,r.createElement(Fe,null,r.createElement(Ge.ZP,{offset:1200,once:!0},r.createElement(r.Suspense,{fallback:r.createElement(ze,null)},r.createElement(Ze,{videoURL:t})))))},image:e=>{let{data:t,alt:a}=e;return r.createElement(Ie,null,r.createElement(Me,{loading:"lazy",src:t,alt:a}))}},Ye=e=>{let{index:t,children:a,heading:n,mediaType:i,mediaData:l,alt:o="",isStrong:s=!0,reversedItems:m=!1}=e;const c=m?!!((t+1)%2):!!(t%2),d=Qe[i];return r.createElement(Le,{isReversed:c},r.createElement(Ke,{isReversed:c},r.createElement(Ae,{isStrong:s},n),a),r.createElement(d,{data:l,alt:o}))},Ne=()=>r.createElement(ve,{heading:"Key Functionalities",id:"key-functionalities",alternativeBackground:!0},r.createElement(Ye,{index:0,heading:"Intuitive Drag & Drop",mediaType:"video",mediaData:"https://youtu.be/8UN8S5WyI8Y",isStrong:!1,reversedItems:!0},r.createElement(he,null,r.createElement(xe,null,"Build your forms in React by using",r.createElement(he,null,r.createElement(xe,null,r.createElement("strong",null,"drag & drop interface")),r.createElement(xe,null,"nested fields"),r.createElement(xe,null,"vertical and horizontal lists"))),r.createElement(xe,null,"Choose Forminer that supports all common field types from",r.createElement(_,{to:"https://uniforms.tools/"}," uniforms")),r.createElement(xe,null,"Use ",r.createElement("strong",null,"WYSIWYG")," code editor, if you prefer it over the no-code interface"),r.createElement(xe,null,"Set field properties",r.createElement(he,null,r.createElement(xe,null,"like required/predefined values (dropdown list)"),r.createElement(xe,null,"min/max length"),r.createElement(xe,null,"placeholder"),r.createElement(xe,null,"default value"),r.createElement(xe,null,"others"))))),r.createElement(Ye,{index:1,heading:"Conditional fields",mediaType:"video",mediaData:"https://youtu.be/Q5_JNpGoxCo",isStrong:!1,reversedItems:!0},r.createElement(he,null,r.createElement(xe,null,"Use",r.createElement("strong",null," conditional field validation"),", and spend your saved time on other areas of your project."),r.createElement(xe,null,"Save your time by a conditional rendering of fields, a",r.createElement("strong",null," display-if "),"solution"),r.createElement(xe,null,"You'll have the support of any logic for any field"),r.createElement(xe,null,"Define logic by",r.createElement("strong",null," no-code interface")))),r.createElement(Ye,{index:2,heading:"Custom fields",mediaType:"video",mediaData:"https://youtu.be/wSkpwRrBN_s",isStrong:!1,reversedItems:!0},r.createElement(he,null,r.createElement(xe,null,"Add simply any new field you'd like"),r.createElement(xe,null,"Use fields already present in your application"),r.createElement(xe,null,"Use any fields from",r.createElement(_,{to:"https://uniforms.tools/"}," uniforms")))),r.createElement(Ye,{index:3,heading:"Schema-based headless approach",mediaType:"video",mediaData:"https://youtu.be/xswDB9qbJKU",isStrong:!1,reversedItems:!0},r.createElement(he,null,r.createElement(xe,null,"Prepare React form once and",r.createElement("strong",null," use it with various themes")),r.createElement(xe,null,"Take advantage of a",r.createElement("strong",null," clear schema definition "),"that operates on data and correct, copy and paste the form",r.createElement("strong",null," directly into your project")),r.createElement(xe,null,"You can",r.createElement("strong",null," create no-code and low-code solutions "),"quickly and well, thanks to schema management with easily display form resources"),r.createElement(xe,null,"Use",r.createElement(_,{to:"https://uniforms.tools/"}," uniforms "),"with full state engine, able to handle logic between fields and custom error messages"))),r.createElement(Ye,{index:4,heading:"Quality of the generated code",mediaType:"video",mediaData:"https://youtu.be/3Av4N_qlN2U",isStrong:!1,reversedItems:!0},r.createElement(he,null,r.createElement(xe,null,"Build React forms through a code, as well as through a",r.createElement("strong",null," WYSIWYG "),"interface, with a",r.createElement("strong",null," stable synchronization "),"between two methods"),r.createElement(xe,null,"Ensure",r.createElement("strong",null," good Developer Experience "),"by choosing a package based on",r.createElement(_,{to:"https://uniforms.tools/"}," uniforms"),", trusted by GitHub community"),r.createElement(xe,null,"Use",r.createElement("strong",null," clean-looking components "),"while keeping extensibility and separation of concerns")))),He="0 0 38 38",Re="19",Ce="19",We=16,qe=l.default.div`
  position: relative;
  min-width: 92px;
  height: auto;
  margin-right: 16px;
...
`,Je=l.default.p`
  ...
  z-index: 3;
`,$e=e=>{let{textContent:t,lastChild:a,length:n}=e;const i=(0,r.useRef)(),l=(e=>{const[t,a]=(0,r.useState)(!1);return(0,r.useEffect)((()=>{const t=new IntersectionObserver((e=>{let[t]=e;return t.isIntersecting&&a(!0)}));return t.observe(e.current),()=>{t.disconnect()}}),[e]),t})(i),o=2*We*Math.PI,s=o-100/n*t/100*o;return r.createElement(qe,{ref:i},r.createElement(Ue,{lastChild:a},r.createElement("svg",{viewBox:He},l&&r.createElement(Xe,{animation:l,stroke:"#1074EF",fill:"transparent",strokeWidth:3,array:o,offset:s,"stroke-width":1,cx:Re,cy:Ce,r:We}))),r.createElement(Je,null,t))},_e=l.default.div`
  position: relative;
  display: flex;
  align-items: center;
  ${c.greaterThan("lg")`
...
`,at=e=>{let{heading:t,children:a,orderNum:n,numOfSteps:i}=e;const l=i===n;return r.createElement(tt,{xs:12,item:!0,lg:!0},r.createElement(_e,{firstChild:1===n,lastChild:l},r.createElement($e,{lastChild:l,textContent:n,length:i}),r.createElement("div",null,r.createElement(et,{bold:!0},t),r.createElement("p",null,a))))},nt=(0,l.default)(v.Z)`
  && {
    margin-top: 60px;
    ${c.greaterThan("lg")`
  margin-top: 100px;
...
`,rt=()=>r.createElement(ve,{heading:"Solution easy to use",id:"easy-to-use"},r.createElement(nt,{container:!0},r.createElement(at,{heading:"Installation",orderNum:1,numOfSteps:3},"We provide you with ",r.createElement("strong",null,"ready-to-use code")),r.createElement(at,{heading:"Modification",orderNum:2,numOfSteps:3},"Based on",r.createElement(_,{to:"https://www.vazco.eu/technologies/reactjs"}," React "),"components"),r.createElement(at,{heading:"Customization",orderNum:3,numOfSteps:3},"Freely modify the look by editing the CSS, either by hand or using indexes and variables")));var it=a(6906);const lt=l.default.div`
  h3 {
...
`,Mt=l.default.p`
  margin-top: 24px;
`,Lt=e=>{let{heading:t,subHeading:a,listItems:n,buttons:i,subtitle:l}=e;return r.createElement(jt,null,r.createElement(zt,null,r.createElement(Pt,null,t),r.createElement(Ft,null,r.createElement(It,null,a),r.createElement($,null,n.map((e=>r.createElement(J,{key:e,theme:"blue"},e)))),l&&r.createElement(Mt,null,r.createElement("strong",null,l)))),r.createElement(Zt,null,i.map((e=>{let{text:t,...a}=e;return r.createElement(_,(0,dt.Z)({key:a.to},a),r.createElement(K,{reversed:!0},t))}))))},Kt=l.default.div`
  max-width: 700px;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Nt=l.default.p`
  margin: 0;
`,Ht=["Monthly","Yearly","Lifelong","Enterprise"],Rt=[{heading:"$149 / month",subHeading:"Within this price, you receive:",listItems:["A multi-tenant license for a single project","Unlimited traffic & users","Internal deployment","Debugging support & free updates"],buttons:[{text:"Buy now",to:"https://sowl.co/s/SPRv4",newTab:!1}]},{heading:"$1490 / year",subHeading:"Within this price, you receive:",listItems:["A multi-tenant license for a single project","Unlimited traffic & users","Internal deployment","Debugging support & free updates"],buttons:[{text:"Buy now",to:"https://sowl.co/s/eEjpk",newTab:!1}]},{heading:"$4900",subHeading:"Within this price, you receive:",listItems:["A multi-tenant lifetime license for a single project","Unlimited traffic & users","Internal deployment","Debugging support & free updates"],buttons:[{text:"Buy now",to:"https://sowl.co/s/7jLwM",newTab:!1}]},{heading:"Price estimation based on your needs",subHeading:"We also provide:",listItems:["Multi-project licenses","Custom extensions","Training sessions","Integrations"],buttons:[{text:"Contact us",to:"https://www.vazco.eu/contact-us",newTab:!1}],subtitle:"Contact us to estimate your project based on business requirements."}],Ct=()=>{const[e,t]=(0,r.useState)(0);return r.createElement(ve,{id:"pricing"},r.createElement(Kt,null,r.createElement(ye,{level:2,size:"lg",marginBottom:24},"Pricing"),r.createElement(Nt,null,"Interested in using Forminer? Find the plan that suits you best."),r.createElement(Qt,null,Ht.map(((a,n)=>r.createElement(Yt,{key:n,current:n===e,onClick:()=>t(n)},a)))),r.createElement(Lt,Rt[e])))};var Wt,qt,Ut=a(2513),Xt=a(4965),Jt=a(2425);function $t(){return $t=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},$t.apply(this,arguments)}const _t=e=>{let{title:t,titleId:a,...n}=e;return r.createElement("svg",$t({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:18,height:18,role:"img","aria-labelledby":a},n),t?r.createElement("title",{id:a},t):null,Wt||(Wt=r.createElement("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"})),qt||(qt=r.createElement("path",{d:"M0 0h24v24H0z",fill:"none"})))},ea=l.default.div`
  max-width: 500px;
`,ta=l.default.p`
  margin: 0;
  font-weight: 500;
`,aa=(0,l.default)((e=>{let{lastChild:t,...a}=e;return r.createElement(Ut.Z,a)}))`
  && {
    box-shadow: none;
...
`,Ea=l.default.a`
  ${fa}
  text-decoration: none !important;
`,ba=[{name:"Demo",link:"demo"},{name:"Docs",link:"docs"},{name:"Custom solutions",link:"https://www.vazco.eu/"}],Aa=[{name:"Installation",link:"https://forminer.com/docs/installation"},{name:"Handling custom components",link:"https://forminer.com/docs/custom-components"},{name:"Integration",link:"https://forminer.com/docs/integration"}],va=()=>{const e=(0,b.Z)(),t=(0,A.Z)(e.breakpoints.down("sm"));return r.createElement(ma,null,r.createElement(B,null,r.createElement(ca,null,r.createElement(sa.Z,{gridColumnGap:20,display:"flex",flexDirection:t?"column":"row",alignContent:"space-around",justifyContent:"space-between",flexWrap:"wrap"},r.createElement(ha,null,r.createElement("img",{width:75,height:75,alt:"forminer logo",src:"img/forminer-logo.svg"}),r.createElement(ua,null,"Powerful tool for building forms in React")),r.createElement(da,null,r.createElement("h5",null,"Product"),r.createElement("ul",null,r.createElement(ka,null,r.createElement(ga,{onClick:e=>((e,t)=>{e.preventDefault();const a=document.getElementById(t);a&&a.scrollIntoView()})(e,"pricing")},"Pricing")),ba.map((e=>r.createElement(ka,{key:e.link},r.createElement(ya,{href:e.link},e.name)))))),r.createElement(da,null,r.createElement("h5",null,"First steps"),r.createElement("ul",null,Aa.map((e=>r.createElement(ka,{key:e.link},r.createElement(ya,{href:e.link},e.name)))))),r.createElement(pa,null,r.createElement("h5",null,"Start a conversation!"),r.createElement(Ea,{href:"mailto:hello@forminer.com"},"hello@forminer.com"),r.createElement(xa,null,r.createElement("a",{href:"https://www.vazco.eu/",target:"_blank",rel:"noreferrer noopener"},r.createElement("img",{src:"img/vazco-logo-2023.svg",alt:"Vazco.eu",width:"150",height:"auto"})),r.createElement("p",{style:{marginBottom:0,fontSize:16}},`Copyright \xa9 2020 - ${(new Date).getFullYear()}`),r.createElement("p",{style:{fontSize:16}},"All Rights Reserved")))))))},wa=()=>r.createElement(r.Fragment,null,r.createElement(E,null),r.createElement(n.Z,null,r.createElement("link",{rel:"preload",href:a(3192),as:"image",type:"image/webp"})),r.createElement(f,null,r.createElement(ce,null),r.createElement(Ne,null),r.createElement(rt,null),r.createElement(mt,{heading:"How can these solutions help your project?",buttonText:"Ask our CTO"}),r.createElement(Dt,null),r.createElement(St,null),r.createElement(Ct,null),r.createElement(Tt,null),r.createElement(oa,null),r.createElement(va,null)))},3192:(e,t,a)=>{a.r(t),a.d(t,{default:()=>n});const n=a.p+"assets/images/forminer-48ddf33de3f8122e534b54e709ce5fe1.webp"}}]);