"use strict";(self.webpackChunkforminer=self.webpackChunkforminer||[]).push([[237],{6906:(e,t,a)=>{a.d(t,{GA:()=>l,W5:()=>n});var i=a(7379);const n=i.css`
  border-radius: 8px;
`,r=i.css`
...
`,x=l.css`
  ...
  `}
`,h=(0,o.Z)({breakpoints:{values:{xs:0,sm:576,md:768,lg:1024,xl:1360}},palette:{primary:{main:"#1074ef"}}}),u={color:{primary:"#1074ef",body:"#000000",grey:"#fafafb",darkGrey:"#f4f5f6",white:"#fff"}},k=l.createGlobalStyle`
${m.Fv}
html {
...
`,f=e=>{let{children:t}=e;return n.createElement(r.Z,{theme:h},n.createElement(k,null),n.createElement(l.ThemeProvider,{theme:u},n.createElement("main",null,t)))};var g=a(5742);const E=JSON.parse('{"TN":"Forminer | Build Forms in React the way you need | Vazco","WL":"Check how Forminer can solve your issues with forms in React. Enjoy your saved time by using conditional field validation, WYSIWYG form editor and more straight from the start and take your business to another level.","vu":"index, follow"}'),y=()=>n.createElement(g.Z,null,n.createElement("title",null,E.TN),n.createElement("meta",{name:"description",content:E.WL}),n.createElement("meta",{property:"robots",content:E.vu}));var b=a(1749);const w=l.default.div`
  max-width: 1360px;
  margin: 0 auto;
  ...
  ${c.greaterThan("xl")`
    ...
    padding-right: 64px;
  `}
`,v=e=>{let{children:t,id:a,className:i,wide:r=!1}=e;return n.createElement(w,{id:a,className:i,wide:r},t)};var A=a(6906);const G=a.p+"assets/images/Forminer-0c33d265e8674f099a738083f7c84533.png",B=l.default.section`
...
`,O=l.default.img`
  width: 100%;
  max-width: 709px;
`,R="#dafaff",j=e=>{let{children:t}=e;return n.createElement(B,{bgColor:R,isFramed:!1},n.createElement(S,{bgColor:R,isFramed:!1},n.createElement(T,{direction:"row-reverse",alignItems:"center",container:!0},n.createElement(I,{xs:12,md:6,item:!0},n.createElement(O,{src:G,alt:"Forminer - Build form in React without any problems"})),n.createElement(b.Z,{xs:12,md:6,item:!0},n.createElement(D,{reversed:!0},t)))))};var V=a(308),C=a.n(V);const P=l.css`
  padding: 0;
  border: none;
  outline: none;
  font: inherit;
...
`,Q=e=>{let{children:t}=e;return n.createElement(L,null,n.createElement(U,null),t)},$=e=>{let{children:t}=e;return n.createElement(Z,null,t)};var W=a(9960);const K=e=>{let{to:t,children:a,internal:i=!1,newTab:r=!0}=e;return i?n.createElement(W.Z,{to:t},a):n.createElement("a",{href:t,target:r?"_blank":"_self",rel:r?"noopener noreferrer":""},a)},X=l.default.div`
  ${c.greaterThan("xl")`
...
`,ee=e=>{e.preventDefault();const t=document.getElementById("pricing");t&&t.scrollIntoView()},te=()=>n.createElement(j,null,n.createElement(X,null,n.createElement("h1",null,"Forminer"),n.createElement(_,null,n.createElement("strong",null,"Save up to 1500 hours")," while building form-heavy React apps with our easy to integrate package"),n.createElement($,null,n.createElement(Q,null,n.createElement("span",null,n.createElement("strong",null,"Powerful solution")," - custom fields, full state machine, conditional fields, schema-first approach, and many more...")),n.createElement(Q,null,n.createElement("span",null,n.createElement("strong",null,"Traffic-independent payment")," - pick a one-time payment or subscription, not based on the number of users")),n.createElement(Q,null,n.createElement("span",null,n.createElement("strong",null,"Good support")," - basing on our popular OpenSource package, uniforms, guarantees no vendor locking"))),n.createElement(q,null,n.createElement(N,{onClick:ee},"Check pricing"),n.createElement(K,{to:"/docs",internal:!0},n.createElement(N,{variant:"outlined"},"See technical documentation"))))),ae=l.default.div`
...
`,ie=(0,l.default)(ae)`
  ...
  ${c.greaterThan("md")`
    ...
    padding-bottom: 75px;
  `}
`,ne=e=>{let{children:t,id:a,alternativeBackground:i}=e;return n.createElement(ie,{id:a,alternativeBackground:i,as:"section"},t)},re=l.default.h2`
  ...
  ${e=>{let{size:t}=e;switch(t){case"xl":return d;case"lg":return p;case"md":return x;default:return l.css`
          ...
          line-height: inherit;
        `}}}
`,le=e=>{let{children:t,level:a=3,size:i="md",isStrong:r=!0,marginBottom:l}=e;return n.createElement(re,{isStrong:r,as:`h${a}`,size:i,marginBottom:l},t)};var oe;function se(){return se=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(e[i]=a[i])}return e},se.apply(this,arguments)}const me=e=>{let{title:t,titleId:a,...i}=e;return n.createElement("svg",se({xmlns:"http://www.w3.org/2000/svg",width:24,height:26,viewBox:"0 0 24 26",role:"img","aria-labelledby":a},i),t?n.createElement("title",{id:a},t):null,oe||(oe=n.createElement("path",{fill:"#1074EF",fillRule:"evenodd",d:"M12.923 0 0 19.067 24 26z"})))},ce=l.default.div`
  display: flex;
...
`,pe=(0,l.default)(le)`
  max-width: 660px;
  font-weight: 300;
`,xe=e=>{let{children:t,level:a=3,size:i="md",isStrong:r=!0}=e;return n.createElement(ce,null,n.createElement(de,null),n.createElement(pe,{level:a,size:i,isStrong:r},t))},he=e=>{let{children:t,heading:a,alternativeBackground:i=!1,id:r}=e;return n.createElement(ne,{alternativeBackground:i,id:r},n.createElement(v,null,a&&n.createElement(xe,{isStrong:!0},a),t))},ue=a.p+"assets/images/bt-7c69b905ff680bf5121929e719301e5a.png",ke=a.p+"assets/images/material-ui-5b2d8a0a309d9f7d47c1a43860f28c7c.png",fe=l.default.div`
  display: grid;
...
`,Be=e=>{let{children:t}=e;return n.createElement(Ae,null,t)},Se=e=>{let{children:t}=e;return n.createElement(Ge,null,t)};var Ie=a(1248),De=a.n(Ie),Te=a(1216);const Oe=l.default.div`
  ...
  ${c.greaterThan("md")`
    ...
    position: relative;
  `}
`,Re=e=>{let{data:t}=e;const a=(0,n.useRef)(null);return(0,n.useEffect)((()=>{let e;if(a.current){const i=JSON.parse(t);e=De().loadAnimation({animationData:i,container:a.current,loop:!0,renderer:"svg"})}return()=>{e.destroy()}}),[t,a]),n.createElement("div",{ref:a})},je=(0,l.default)(Oe)`
  ${c.greaterThan("md")`
    min-height: 600px;
  `}
`,Ve=l.default.div`
...
`;var Ce=a(5477);const Pe=l.default.div`
  ...
  ${c.greaterThan("md")`
    min-height: 400px;
  `}
`,Fe=()=>n.createElement(Pe,null,n.createElement(Ce.Z,null)),He=(0,n.lazy)((()=>Promise.all([a.e(4),a.e(307)]).then(a.bind(a,307)))),ze=(0,l.default)(Oe)`
  ${c.greaterThan("md")`
    min-height: 600px;
  `}
`,Ne=l.default.div`
...
`,tt=l.default.p`
  ...
  z-index: 3;
`,at=e=>{let{textContent:t,lastChild:a,length:i}=e;const r=(0,n.useRef)(),l=(e=>{const[t,a]=(0,n.useState)(!1);return(0,n.useEffect)((()=>{const t=new IntersectionObserver((e=>{let[t]=e;return t.isIntersecting&&a(!0)}));return t.observe(e.current),()=>{t.disconnect()}}),[e]),t})(r),o=2*Xe*Math.PI,s=o-100/i*t/100*o;return n.createElement(qe,{ref:r},n.createElement(_e,{lastChild:a},n.createElement("svg",{viewBox:$e},l&&n.createElement(et,{animation:l,stroke:"#1074EF",fill:"transparent",strokeWidth:3,array:o,offset:s,"stroke-width":1,cx:We,cy:Ke,r:Xe}))),n.createElement(tt,null,t))},it=l.default.div`
  position: relative;
  display: flex;
  align-items: center;
  ${c.greaterThan("lg")`
...
`,lt=e=>{let{heading:t,children:a,orderNum:i,numOfSteps:r}=e;const l=r===i;return n.createElement(rt,{xs:12,item:!0,lg:!0},n.createElement(it,{firstChild:1===i,lastChild:l},n.createElement(at,{lastChild:l,textContent:i,length:r}),n.createElement("div",null,n.createElement(nt,{bold:!0},t),n.createElement("p",null,a))))},ot=(0,l.default)(b.Z)`
  && {
    margin-top: 60px;
    ${c.greaterThan("lg")`
  margin-top: 100px;
...
`,st=()=>n.createElement(he,{heading:"Solution easy to use",id:"easy-to-use"},n.createElement(ot,{container:!0},n.createElement(lt,{heading:"Installation",orderNum:1,numOfSteps:3},"We provide you with ",n.createElement("strong",null,"ready-to-use code")),n.createElement(lt,{heading:"Modification",orderNum:2,numOfSteps:3},"Based on",n.createElement(K,{to:"https://www.vazco.eu/technologies/reactjs"}," React "),"components"),n.createElement(lt,{heading:"Customization",orderNum:3,numOfSteps:3},"Freely modify the look by editing the CSS, either by hand or using indexes and variables"))),mt=l.default.div`
...
`,pt=e=>{let{heading:t,buttonText:a}=e;return n.createElement(mt,null,n.createElement(v,null,n.createElement(ct,null,n.createElement(dt,null,t),n.createElement(K,{to:"mailto:hello@forminer.com",newTab:!1},n.createElement(N,{variant:"outlined",reversed:!0},a)))))};var xt,ht=a(7462);function ut(){return ut=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(e[i]=a[i])}return e},ut.apply(this,arguments)}const kt=e=>{let{title:t,titleId:a,...i}=e;return n.createElement("svg",ut({viewBox:"0 0 41.25 41.25",height:55,width:55,xmlns:"http://www.w3.org/2000/svg",role:"img","aria-labelledby":a},i),t?n.createElement("title",{id:a},t):null,xt||(xt=n.createElement("defs",null,n.createElement("clipPath",{id:"a"},n.createElement("path",{d:"M.418 1.086h39.773V39.39H.418Zm0 0"})))),n.createElement("g",{clipPath:"url(#a)"},n.createElement("path",{d:"M30.371 1.324a.64.64 0 0 0-.496-.195.67.67 0 0 0-.48.234l-4.86 5.684-4.297.879-4.293-.88-4.86-5.683a.677.677 0 0 0-.48-.234.686.686 0 0 0-.5.195L.633 10.883a.657.657 0 0 0-.031.894l4.933 5.774.832 2.144-2.125 2.489a4.642 4.642 0 0 0 .281 6.324l9.872 9.637a4.67 4.67 0 0 0 3.257 1.332c.903 0 1.801-.282 2.586-.809.758.508 1.649.8 2.582.8a4.674 4.674 0 0 0 3.258-1.323L36.836 27.64a3.315 3.315 0 0 0 .203-4.516l-1.332-1.559c-.492-.578-1.184-.933-1.91-1.066l1.144-2.95 4.934-5.773a.666.666 0 0 0-.031-.898ZM2.011 11.383l8.532-8.61 4.543 5.305a.665.665 0 0 0 .371.223l4.648.949h.008l5.95 1.219a2.616 2.616 0 0 1 2.042 3.086 2.626 2.626 0 0 1-3.097 2.039l-6.051-1.239a2.973 2.973 0 0 0-1.781.192 11.564 11.564 0 0 1-6.653.797.678.678 0 0 0-.62.222l-2.551 2.985-.614-1.582a.564.564 0 0 0-.113-.192Zm13.321 25.812-.469-.453 2.38-2.582c.081.805.355 1.598.866 2.293.067.086.133.172.203.25l.895 1.05a3.303 3.303 0 0 1-3.875-.558Zm9.648.157a3.328 3.328 0 0 1-2.152.793c-.98 0-1.902-.422-2.535-1.165l-.969-1.132a3.313 3.313 0 0 1 .555-4.816l.281-.208 5.457 5.914-.469.457c-.054.055-.113.11-.168.157Zm4.254-13.204 4.399 4.77-3.055 2.984-4.805-5.203Zm-4.539 3.34 4.93 5.34-3.055 2.984-5.332-5.777Zm11.336-3.504a1.995 1.995 0 0 1-.12 2.711l-1.329 1.293-4.273-4.629 1.687-1.242a1.981 1.981 0 0 1 1.188-.387c.582 0 1.136.254 1.52.7Zm-2.176-7.207a.728.728 0 0 0-.113.192l-1.379 3.55a3.26 3.26 0 0 0-1.16.532L19.09 29.969c-1.11.812-1.73 2.031-1.852 3.304-.011-.015-.02-.035-.035-.05a.662.662 0 0 0-.937.043l-2.356 2.547-3.058-2.981 5.105-5.527a.662.662 0 0 0-.039-.938.667.667 0 0 0-.941.04l-5.075 5.491-3.054-2.984 4.98-5.394a.658.658 0 0 0-.039-.938.667.667 0 0 0-.941.04l-4.953 5.366-.438-.43a3.315 3.315 0 0 1-.207-4.515l5.418-6.332c2.395.348 4.82.023 7.039-.953a1.64 1.64 0 0 1 .977-.102l6.046 1.235a3.948 3.948 0 0 0 2.973-.57 3.888 3.888 0 0 0 1.7-2.497 3.952 3.952 0 0 0-3.079-4.656l-2.781-.566 1.477-.305a.65.65 0 0 0 .37-.219l4.54-5.308 8.535 8.609Zm0 0",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}})))};var ft;function gt(){return gt=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(e[i]=a[i])}return e},gt.apply(this,arguments)}const Et=e=>{let{title:t,titleId:a,...i}=e;return n.createElement("svg",gt({viewBox:"0 0 41.25 41.25",height:55,width:55,xmlns:"http://www.w3.org/2000/svg",role:"img","aria-labelledby":a},i),t?n.createElement("title",{id:a},t):null,ft||(ft=n.createElement("defs",null,n.createElement("clipPath",{id:"a"},n.createElement("path",{d:"M5 19h30v20.688H5Zm0 0"})),n.createElement("clipPath",{id:"b"},n.createElement("path",{d:"M.648 1h39.04v21H.648Zm0 0"})),n.createElement("clipPath",{id:"c"},n.createElement("path",{d:"M27 .648h12.688V13H27Zm0 0"})))),n.createElement("path",{d:"M24.207 22.188a4.044 4.044 0 0 0-4.039-4.04 4.044 4.044 0 0 0-4.04 4.04 4.044 4.044 0 0 0 4.04 4.039 4.044 4.044 0 0 0 4.039-4.04M20.102 27.57l-.098-.004-.484 5.809.648.648.648-.648-.484-5.8h-.164c-.02 0-.043-.005-.066-.005",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}}),n.createElement("g",{clipPath:"url(#a)"},n.createElement("path",{d:"M33.746 19.496c-.324 0-.64.129-.871.36l-5.258 5.257a7.443 7.443 0 0 1-4.187 2.098l-1.754.246.535 6.43-2.043 2.043-2.043-2.043.535-6.426-1.754-.25a7.443 7.443 0 0 1-4.187-2.098L7.46 19.855a1.233 1.233 0 0 0-1.742 1.742l9.738 9.735v8.355h9.422v-8.355l9.738-9.734a1.23 1.23 0 0 0-.871-2.102",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}})),n.createElement("g",{clipPath:"url(#b)"},n.createElement("path",{d:"m27.375 17.277-.953-.949.871-.871h-14.25l.871.871-.953.95-2.496-2.493 2.496-2.496.953.95-.871.87h14.25l-.871-.87.953-.95 2.496 2.496ZM8.156 10.855l-1.328-.222a8.716 8.716 0 0 1 8.629-7.293v1.348a7.373 7.373 0 0 0-7.3 6.167Zm8.758-7.394c.496.082.988.21 1.457.375l-.445 1.273a7.078 7.078 0 0 0-1.235-.32Zm18.734 9.976a4.044 4.044 0 0 0-4.039 4.04h-1.343a5.388 5.388 0 0 1 5.261-5.38c-.636-3.456-3.695-6.066-7.28-6.066a7.33 7.33 0 0 0-3.423.844l-.543.285-.336-.515a10.042 10.042 0 0 0-8.488-4.649c-5.57 0-10.098 4.527-10.098 10.094v.047a5.383 5.383 0 0 1 3.746 2.261L8 15.168a4.046 4.046 0 0 0-3.313-1.73 4.044 4.044 0 0 0-4.039 4.039 4.043 4.043 0 0 0 3.485 3.996 2.636 2.636 0 0 1-.117-.746 2.58 2.58 0 0 1 2.574-2.579c.691 0 1.336.27 1.824.754l2.61 2.614h3.808a5.385 5.385 0 0 1 5.336-4.711 5.385 5.385 0 0 1 5.336 4.71h3.808l2.614-2.613a2.562 2.562 0 0 1 1.82-.754 2.583 2.583 0 0 1 2.578 2.579c0 .257-.05.507-.12.746a4.043 4.043 0 0 0 3.483-3.996 4.044 4.044 0 0 0-4.039-4.04",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}})),n.createElement("g",{clipPath:"url(#c)"},n.createElement("path",{d:"m38.21 6.145-.108-.352a5.261 5.261 0 0 0-.383-.926l-.172-.328.758-1.332-1.176-1.176-1.332.762-.328-.176a5.35 5.35 0 0 0-.922-.383l-.356-.109L33.79.648h-1.664l-.402 1.477-.352.11a5.261 5.261 0 0 0-.926.382l-.328.176-1.332-.762-1.176 1.176.762 1.332-.078.152c.52 0 1.031.051 1.531.145a4.012 4.012 0 0 1 3.133-1.496 4.044 4.044 0 0 1 4.04 4.039c0 .875-.294 1.707-.813 2.402.359.766.601 1.594.718 2.461.188.047.371.102.547.164l.856-.855-.758-1.332.172-.328c.156-.301.289-.61.383-.922l.109-.356 1.477-.402V6.547l-1.477-.402",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}})),n.createElement("path",{d:"M35.418 8.453c.148-.336.23-.7.23-1.074a2.694 2.694 0 0 0-2.691-2.691c-.61 0-1.184.203-1.648.566a8.853 8.853 0 0 1 4.109 3.2",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}}))};var yt;function bt(){return bt=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(e[i]=a[i])}return e},bt.apply(this,arguments)}const wt=e=>{let{title:t,titleId:a,...i}=e;return n.createElement("svg",bt({viewBox:"0 0 41.25 41.25",height:55,width:55,xmlns:"http://www.w3.org/2000/svg",role:"img","aria-labelledby":a},i),t?n.createElement("title",{id:a},t):null,yt||(yt=n.createElement("defs",null,n.createElement("clipPath",{id:"a"},n.createElement("path",{d:"M1.055 1.055h38.3v38.3h-38.3Zm0 0"})))),n.createElement("path",{d:"m20.234 19.383 6.121 6.144a2.028 2.028 0 0 0 2.84-.035 2.028 2.028 0 0 0 .012-2.84l-6.113-6.144c-.696.703.168-.164-2.86 2.875Zm0 0",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}}),n.createElement("path",{d:"m30.02 9.547-2.73 2.746a.662.662 0 0 1-.47.195h-2.84a.66.66 0 0 1-.66-.66v-2.86c0-.171.07-.34.192-.46L26.25 5.75a4.73 4.73 0 0 0-4.527 1.703 4.728 4.728 0 0 0-.653 4.793.662.662 0 0 1-.14.719C18.457 15.469 17.914 16 10.707 23.246a1.353 1.353 0 1 0 1.902 1.926c16.63-16.719 6.782-6.813 10.23-10.281a.66.66 0 0 1 .724-.141 4.718 4.718 0 0 0 4.785-.672 4.709 4.709 0 0 0 1.672-4.531Zm0 0",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}}),n.createElement("g",{clipPath:"url(#a)"},n.createElement("path",{d:"M35.371 1.055H5.027A3.954 3.954 0 0 0 1.07 5.012v22.43a3.954 3.954 0 0 0 3.957 3.956h7.258s.473 4.258-2.586 6.766a.66.66 0 0 0 .438 1.18c3.246-.227 8.699-1.57 10.062-7.946h15.172c2.188 0 3.961-1.77 3.961-3.957V5.011a3.958 3.958 0 0 0-3.96-3.956ZM5.027 4.352h-.66a.662.662 0 0 1-.66-.66c0-.364.297-.66.66-.66h.66c.364 0 .66.296.66.66 0 .363-.296.66-.66.66Zm1.98-.66c0-.364.294-.66.657-.66h3.3c.364 0 .661.296.661.66 0 .363-.297.66-.66.66h-3.3a.659.659 0 0 1-.657-.66Zm23.087 25.73h-.657a.66.66 0 1 1 0-1.32h.657a.66.66 0 1 1 0 1.32Zm.047-7.7a3.347 3.347 0 0 1 .718 3.641 3.354 3.354 0 0 1-3.074 2.078 3.303 3.303 0 0 1-2.363-.984l-6.117-6.14-5.758 5.785c-.5.507-1.18.793-1.89.793a2.698 2.698 0 0 1-2.462-1.668 2.695 2.695 0 0 1 .575-2.915l6.71-6.742-2.914-2.93a.646.646 0 0 1-.511.2.644.644 0 0 1-.485-.254l-3.316-4.29a.656.656 0 0 1 .055-.866l1.894-1.907a.662.662 0 0 1 .875-.05l4.266 3.332a.667.667 0 0 1 .05.996l2.91 2.93.391-.399a6.027 6.027 0 0 1 8.047-7.508.652.652 0 0 1 .39.48.654.654 0 0 1-.175.59l-3.32 3.344v1.926h1.906l3.316-3.336a.67.67 0 0 1 .594-.183.671.671 0 0 1 .485.394 6.035 6.035 0 0 1-6.086 8.367Zm5.89 7.7h-3.297a.66.66 0 1 1 0-1.32h3.297a.66.66 0 1 1 0 1.32Zm0 0",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}})),n.createElement("path",{d:"M18.371 13.668c-3.586-3.613-3.598-3.496-3.555-3.934 0-.086.028-.171.079-.246.011-.035.03-.066.05-.101L11.727 6.87 10.652 7.95l2.508 3.239c.008-.008.176-.094.188-.098.078-.02.156-.035.238-.04.363.009.195-.066 3.824 3.583Zm0 0",style:{stroke:"none",fillRule:"nonzero",fill:"#1e7cf0",fillOpacity:1}}))},vt=(0,l.default)(b.Z)`
  && {
    &:not(:last-child) {
