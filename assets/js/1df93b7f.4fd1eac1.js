...
`,l=n.css`
  ${r}
  ${i}
`},7510:(e,t,a)=>{a.r(t),a.d(t,{default:()=>Aa});var n=a(9960),r=a(7676),i=a(7294),l=a(3457),o=a(7379),s=a(4968),m=a(8770),c=a(7704);const d=(0,a(605).Jq)({xs:"0",sm:"576px",md:"768px",lg:"1024px",xl:"1360px",xxl:"1920px"}),p=o.css`
...
`,h=o.css`
  ...
  `}
`,u=(0,s.Z)({breakpoints:{values:{xs:0,sm:576,md:768,lg:1024,xl:1360}},palette:{primary:{main:"#1074ef"}}}),k={color:{primary:"#1074ef",body:"#000000",grey:"#fafafb",darkGrey:"#f4f5f6",white:"#fff"}},f=o.createGlobalStyle`
${c.Fv}
html {
...
`,g=e=>{let{children:t}=e;return i.createElement(l.Z,{theme:u},i.createElement(f,null),i.createElement(o.ThemeProvider,{theme:k},i.createElement("main",null,t)))};var y=a(5742);const E=JSON.parse('{"TN":"Forminer | Build Forms in React the way you need | Vazco","WL":"Check how Forminer can solve your issues with forms in React. Enjoy your saved time by using conditional field validation, WYSIWYG form editor and more straight from the start and take your business to another level.","vu":"index, follow"}'),A=()=>i.createElement(y.Z,null,i.createElement("title",null,E.TN),i.createElement("meta",{name:"description",content:E.WL}),i.createElement("meta",{property:"robots",content:E.vu}));var b=a(1749);const v=o.default.div`
  max-width: 1360px;
  margin: 0 auto;

  ${e=>{let{wide:t}=e;return!t&&o.css`
      padding-left: 16px;
      padding-right: 16px;
    `}}
  ...
  ${d.greaterThan("xl")`
    ...
    padding-right: 64px;
  `}
`,w=e=>{let{children:t,id:a,className:n,wide:r=!1}=e;return i.createElement(v,{id:a,className:n,wide:r},t)};var B=a(6906),G=a(3857);const D=o.default.section`
  padding: ${e=>{let{isFramed:t}=e;return t?"16px":"16px 16px 80px 16px"}};
  display: flex;
  align-items: center;

  ${d.greaterThan("md")`
    ${e=>{let{isFramed:t}=e;return!t&&o.css`
  ...
  ${e=>{let{bgColor:t,isFramed:a}=e;return t&&!a&&o.css`
      background-color: ${t};
    `}}
`,V=(0,o.default)(w)`
  width: 100%;
  ...
  ${e=>{let{isFramed:t,bgColor:a}=e;return t&&o.css`
      ${B.GA};
      background-color: ${a};
    `}}
`,S=(0,o.default)(b.Z)`
...
`,j=o.default.img`
  max-width: 100%;
  height: auto;
`,z="#dafaff",F=e=>{let{children:t}=e;return i.createElement(D,{bgColor:z,isFramed:!1},i.createElement(V,{bgColor:z,isFramed:!1},i.createElement(T,{direction:"row-reverse",alignItems:"center",container:!0},i.createElement(S,{xs:12,md:6,item:!0},i.createElement(j,{src:G.default,alt:"Forminer - Build form in React without any problems"})),i.createElement(b.Z,{xs:12,md:6,item:!0},i.createElement(O,{reversed:!0},t)))))};var P=a(308),Z=a.n(P);const I=o.css`
  padding: 0;
  border: none;
  outline: none;
  font: inherit;
  ...
  background: none;
`,M=o.css`
  ${e=>{let{theme:t}=e;return o.css`
    background-color: ${t.color.primary};
    color: ${t.color.white};
    &:hover:not(:disabled) {
      background-color: ${(0,m.$n)(.1,`${t.color.primary}`)};
      border-color: ${(0,m.$n)(.1,`${t.color.primary}`)};
    }
  `}}
`,L=o.css`
  cursor: pointer;
  ...
  &:disabled {
    background-color: ${e=>{let{theme:t}=e;return(0,m.$n)(.2,`${t.color.primary}`)}};
    border-color: ${e=>{let{theme:t}=e;return(0,m.$n)(.2,`${t.color.primary}`)}};
  }

  ${e=>{let{theme:t,variant:a,reversed:n}=e;return"solid"===a?o.css`
        ${M}
      `:n&&"outlined"===a?o.css`
        color: ${t.color.white};
...
`,K=o.default.button`
  ${I}
  ${L}
`,Q=e=>{let{children:t,className:a,disabled:n=!1,onClick:r=Z(),reversed:l=!1,size:o="md",type:s="button",variant:m="solid"}=e;return i.createElement(K,{className:a,disabled:n,onClick:r,reversed:l,size:o,type:s,variant:m},t)};var Y;function N(){return N=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},N.apply(this,arguments)}const R=e=>{let{title:t,titleId:a,...n}=e;return i.createElement("svg",N({xmlns:"http://www.w3.org/2000/svg",width:39,height:39,viewBox:"0 0 39 39",role:"img","aria-labelledby":a},n),t?i.createElement("title",{id:a},t):null,Y||(Y=i.createElement("g",{fill:"none",transform:"translate(2 2)"},i.createElement("ellipse",{cx:17.723,cy:17.723,stroke:"#1074EF",strokeWidth:3,rx:17.723,ry:17.711}),i.createElement("path",{fill:"#1074EF",d:"m16.302 27.144-8.38-6.528 2.383-3.058 5.146 4.009 8.492-12.255 3.187 2.207z"}))))},H=o.default.ul`
...
`,W=e=>{let{children:t}=e;return i.createElement(C,null,i.createElement(q,null),t)},U=e=>{let{children:t}=e;return i.createElement(H,null,t)},X=e=>{let{to:t,children:a,internal:r=!1,newTab:l=!0}=e;return r?i.createElement(n.Z,{to:t},a):i.createElement("a",{href:t,target:l?"_blank":"_self",rel:l?"noopener noreferrer":""},a)},J=o.default.div`
  ${d.greaterThan("xl")`
    margin-left: ${(0,m.hO)("66px")};
  `}
`,$=o.default.div`
  display: inline-flex;
  flex-wrap: wrap;
...
`,_=o.default.p`
  ...
  &:not(:last-child) {
    margin-bottom: ${(0,m.hO)("30px")};
    ${d.greaterThan("md")`
      margin-bottom: ${(0,m.hO)("50px")};
    `}
  }
`,ee=e=>{e.preventDefault();const t=document.getElementById("pricing");t&&t.scrollIntoView()},te=()=>i.createElement(F,null,i.createElement(J,null,i.createElement("h1",null,"Forminer"),i.createElement(_,null,i.createElement("strong",null,"Save up to 1500 hours")," while building form-heavy React apps with our easy to integrate package"),i.createElement(U,null,i.createElement(W,null,i.createElement("span",null,i.createElement("strong",null,"Powerful solution")," - custom fields, full state machine, conditional fields, schema-first approach, and many more...")),i.createElement(W,null,i.createElement("span",null,i.createElement("strong",null,"Traffic-independent payment")," - pick a one-time payment or subscription, not based on the number of users")),i.createElement(W,null,i.createElement("span",null,i.createElement("strong",null,"Good support")," - basing on our popular OpenSource package, uniforms, guarantees no vendor locking"))),i.createElement($,null,i.createElement(Q,{onClick:ee},"Check pricing"),i.createElement(X,{to:"/docs",internal:!0},i.createElement(Q,{variant:"outlined"},"See technical documentation"))))),ae=o.default.div`
...
`,ne=(0,o.default)(ae)`
  ...
  ${d.greaterThan("md")`
    ...
    padding-bottom: 75px;
  `}
`,re=e=>{let{children:t,id:a,alternativeBackground:n}=e;return i.createElement(ne,{id:a,alternativeBackground:n,as:"section"},t)},ie=o.default.h2`
  ...
  ${e=>{let{size:t}=e;switch(t){case"xl":return p;case"lg":return x;case"md":return h;default:return o.css`
          ...
          line-height: inherit;
        `}}}
`,le=e=>{let{children:t,level:a=3,size:n="md",isStrong:r=!0,marginBottom:l}=e;return i.createElement(ie,{isStrong:r,as:`h${a}`,size:n,marginBottom:l},t)};var oe;function se(){return se=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},se.apply(this,arguments)}const me=e=>{let{title:t,titleId:a,...n}=e;return i.createElement("svg",se({xmlns:"http://www.w3.org/2000/svg",width:24,height:26,viewBox:"0 0 24 26",role:"img","aria-labelledby":a},n),t?i.createElement("title",{id:a},t):null,oe||(oe=i.createElement("path",{fill:"#1074EF",fillRule:"evenodd",d:"M12.923 0 0 19.067 24 26z"})))},ce=o.default.div`
  display: flex;
...
`,pe=(0,o.default)(le)`
  max-width: 660px;
  font-weight: 300;
`,xe=e=>{let{children:t,level:a=3,size:n="md",isStrong:r=!0}=e;return i.createElement(ce,null,i.createElement(de,null),i.createElement(pe,{level:a,size:n,isStrong:r},t))},he=e=>{let{children:t,heading:a,alternativeBackground:n=!1,id:r}=e;return i.createElement(re,{alternativeBackground:n,id:r},i.createElement(w,null,a&&i.createElement(xe,{isStrong:!0},a),t))},ue=o.default.div`
  display: grid;
...
`,we=e=>{let{children:t}=e;return i.createElement(be,null,t)},Be=e=>{let{children:t}=e;return i.createElement(ve,null,t)};var Ge=a(1248),De=a.n(Ge),Ve=a(1216);const Se=o.default.div`
  ...
  ${d.greaterThan("md")`
    ...
    position: relative;
  `}
`,Oe=e=>{let{data:t}=e;const a=(0,i.useRef)(null);return(0,i.useEffect)((()=>{let e;if(a.current){const n=JSON.parse(t);e=De().loadAnimation({animationData:n,container:a.current,loop:!0,renderer:"svg"})}return()=>{e.destroy()}}),[t,a]),i.createElement("div",{ref:a})},Te=(0,o.default)(Se)`
  ${d.greaterThan("md")`
    min-height: 600px;
  `}
`,je=o.default.div`
  width: 100%;
`;var ze=a(5477);const Fe=o.default.div`
  width: 100%;
  min-height: 200px;
  height: 100%;
  display: flex;
  ...
  ${d.greaterThan("md")`
    min-height: 400px;
  `}
`,Pe=()=>i.createElement(Fe,null,i.createElement(ze.Z,null)),Ze=(0,i.lazy)((()=>Promise.all([a.e(655),a.e(307)]).then(a.bind(a,307)))),Ie=(0,o.default)(Se)`
  ${d.greaterThan("md")`
    min-height: 600px;
  `}
`,Me=o.default.div`
...
`,Ye=o.default.div`
  ...
  ${d.greaterThan("md")`
    ...
    padding-top: 58px;
    padding-bottom: 58px;
    ${e=>{let{indent:t,isReversed:a}=e;return!t&&(a?o.css`
            padding-right: 0;
          `:o.css`
            padding-left: 0;
          `)}}
...
`,Ne={animation:e=>{let{data:t}=e;return i.createElement(Te,null,i.createElement(je,null,i.createElement(Ve.ZP,{offset:1200,once:!0},i.createElement(Oe,{data:t}))))},video:e=>{let{data:t}=e;return i.createElement(Ie,null,i.createElement(Me,null,i.createElement(Ve.ZP,{offset:1200,once:!0},i.createElement(i.Suspense,{fallback:i.createElement(Pe,null)},i.createElement(Ze,{videoURL:t})))))},image:e=>{let{data:t,alt:a}=e;return i.createElement(Le,null,i.createElement(Ke,{loading:"lazy",src:t,alt:a}))}},Re=e=>{let{index:t,children:a,heading:n,mediaType:r,mediaData:l,alt:o="",indent:s=!1,isStrong:m=!0,reversedItems:c=!1}=e;const d=c?!!((t+1)%2):!!(t%2),p=Ne[r];return i.createElement(Qe,{isReversed:d},i.createElement(Ye,{indent:s,isReversed:d},i.createElement(xe,{isStrong:m},n),a),i.createElement(p,{data:l,alt:o}))},He=()=>i.createElement(he,{heading:"Key Functionalities",id:"key-functionalities",alternativeBackground:!0},i.createElement(Re,{index:0,heading:"Intuitive Drag & Drop",mediaType:"video",mediaData:"https://youtu.be/8UN8S5WyI8Y",isStrong:!1,indent:!0,reversedItems:!0},i.createElement(Be,null,i.createElement(we,null,"Build your forms in React by using",i.createElement(Be,null,i.createElement(we,null,i.createElement("strong",null,"drag & drop interface")),i.createElement(we,null,"nested fields"),i.createElement(we,null,"vertical and horizontal lists"))),i.createElement(we,null,"Choose Forminer that supports all common field types from",i.createElement(X,{to:"https://uniforms.tools/"}," uniforms")),i.createElement(we,null,"Use ",i.createElement("strong",null,"WYSIWYG")," code editor, if you prefer it over the no-code interface"),i.createElement(we,null,"Set field properties",i.createElement(Be,null,i.createElement(we,null,"like required/predefined values (dropdown list)"),i.createElement(we,null,"min/max length"),i.createElement(we,null,"placeholder"),i.createElement(we,null,"default value"),i.createElement(we,null,"others"))))),i.createElement(Re,{index:1,heading:"Conditional fields",mediaType:"video",mediaData:"https://youtu.be/Q5_JNpGoxCo",isStrong:!1,indent:!0,reversedItems:!0},i.createElement(Be,null,i.createElement(we,null,"Use",i.createElement("strong",null," conditional field validation"),", and spend your saved time on other areas of your project."),i.createElement(we,null,"Save your time by a conditional rendering of fields, a",i.createElement("strong",null," display-if "),"solution"),i.createElement(we,null,"You'll have the support of any logic for any field"),i.createElement(we,null,"Define logic by",i.createElement("strong",null," no-code interface")))),i.createElement(Re,{index:2,heading:"Custom fields",mediaType:"video",mediaData:"https://youtu.be/wSkpwRrBN_s",isStrong:!1,indent:!0,reversedItems:!0},i.createElement(Be,null,i.createElement(we,null,"Add simply any new field you'd like"),i.createElement(we,null,"Use fields already present in your application"),i.createElement(we,null,"Use any fields from",i.createElement(X,{to:"https://uniforms.tools/"}," uniforms")))),i.createElement(Re,{index:3,heading:"Schema-based headless approach",mediaType:"video",mediaData:"https://youtu.be/xswDB9qbJKU",isStrong:!1,indent:!0,reversedItems:!0},i.createElement(Be,null,i.createElement(we,null,"Prepare React form once and",i.createElement("strong",null," use it with various themes")),i.createElement(we,null,"Take advantage of a",i.createElement("strong",null," clear schema definition "),"that operates on data and correct, copy and paste the form",i.createElement("strong",null," directly into your project")),i.createElement(we,null,"You can",i.createElement("strong",null," create no-code and low-code solutions "),"quickly and well, thanks to schema management with easily display form resources"),i.createElement(we,null,"Use",i.createElement(X,{to:"https://uniforms.tools/"}," uniforms "),"with full state engine, able to handle logic between fields and custom error messages"))),i.createElement(Re,{index:4,heading:"Quality of the generated code",mediaType:"video",mediaData:"https://youtu.be/3Av4N_qlN2U",isStrong:!1,indent:!0,reversedItems:!0},i.createElement(Be,null,i.createElement(we,null,"Build React forms through a code, as well as through a",i.createElement("strong",null," WYSIWYG "),"interface, with a",i.createElement("strong",null," stable synchronization "),"between two methods"),i.createElement(we,null,"Ensure",i.createElement("strong",null," good Developer Experience "),"by choosing a package based on",i.createElement(X,{to:"https://uniforms.tools/"}," uniforms"),", trusted by GitHub community"),i.createElement(we,null,"Use",i.createElement("strong",null," clean-looking components "),"while keeping extensibility and separation of concerns")))),qe="0 0 38 38",Ce="19",We="19",Ue=16,Xe=o.default.div`
  position: relative;
  min-width: 92px;
  height: auto;
  margin-right: 16px;
...
`,_e=o.default.p`
  ...
  z-index: 3;
`,et=e=>{let{textContent:t,lastChild:a,length:n}=e;const r=(0,i.useRef)(),l=(e=>{const[t,a]=(0,i.useState)(!1);return(0,i.useEffect)((()=>{const t=new IntersectionObserver((e=>{let[t]=e;return t.isIntersecting&&a(!0)}));return t.observe(e.current),()=>{t.disconnect()}}),[e]),t})(r),o=2*Ue*Math.PI,s=o-100/n*t/100*o;return i.createElement(Xe,{ref:r},i.createElement(Je,{lastChild:a},i.createElement("svg",{viewBox:qe},l&&i.createElement($e,{animation:l,stroke:"#1074EF",fill:"transparent",strokeWidth:3,array:o,offset:s,"stroke-width":1,cx:Ce,cy:We,r:Ue}))),i.createElement(_e,null,t))},tt=o.default.div`
  position: relative;
  display: flex;
  align-items: center;
  ${d.greaterThan("lg")`
...
`,rt=e=>{let{heading:t,children:a,orderNum:n,numOfSteps:r}=e;const l=r===n;return i.createElement(nt,{xs:12,item:!0,lg:!0},i.createElement(tt,{firstChild:1===n,lastChild:l},i.createElement(et,{lastChild:l,textContent:n,length:r}),i.createElement("div",null,i.createElement(at,{bold:!0},t),i.createElement("p",null,a))))},it=(0,o.default)(b.Z)`
  && {
    margin-top: 60px;
    ${d.greaterThan("lg")`
  margin-top: 100px;
...
`,lt=()=>i.createElement(he,{heading:"Solution easy to use",id:"easy-to-use"},i.createElement(it,{container:!0},i.createElement(rt,{heading:"Installation",orderNum:1,numOfSteps:3},"We provide you with ",i.createElement("strong",null,"ready-to-use code")),i.createElement(rt,{heading:"Modification",orderNum:2,numOfSteps:3},"Based on",i.createElement(X,{to:"https://www.vazco.eu/technologies/reactjs"}," React "),"components"),i.createElement(rt,{heading:"Customization",orderNum:3,numOfSteps:3},"Freely modify the look by editing the CSS, either by hand or using indexes and variables"))),ot=o.default.div`
...
`,Lt=o.default.p`
  margin-top: 24px;
`,Kt=e=>{let{heading:t,subHeading:a,listItems:n,buttons:r,subtitle:l}=e;return i.createElement(zt,null,i.createElement(Ft,null,i.createElement(Zt,null,t),i.createElement(It,null,i.createElement(Mt,null,a),i.createElement(U,null,n.map((e=>i.createElement(W,{key:e},e)))),l&&i.createElement(Lt,null,i.createElement("strong",null,l)))),i.createElement(Pt,null,r.map(((e,t)=>{let{text:a,...n}=e;return i.createElement(X,(0,pt.Z)({key:n.to},n),i.createElement(Q,{variant:0===t?"solid":"outlined"},a))}))))},Qt=o.default.div`
  max-width: 700px;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Rt=o.default.p`
  margin: 0;
`,Ht=["Monthly","Yearly","Lifelong","Enterprise"],qt=[{heading:"$149 / month",subHeading:"Within this price, you receive:",listItems:["A multi-tenant license for a single project","Unlimited traffic & users","Internal deployment","Debugging support & free updates"],buttons:[{text:"Buy now",to:"https://sowl.co/s/SPRv4",newTab:!1}]},{heading:"$1490 / year",subHeading:"Within this price, you receive:",listItems:["A multi-tenant license for a single project","Unlimited traffic & users","Internal deployment","Debugging support & free updates"],buttons:[{text:"Buy now",to:"https://sowl.co/s/eEjpk",newTab:!1}]},{heading:"$4900",subHeading:"Within this price, you receive:",listItems:["A multi-tenant lifetime license for a single project","Unlimited traffic & users","Internal deployment","Debugging support & free updates"],buttons:[{text:"Buy now",to:"https://sowl.co/s/7jLwM",newTab:!1}]},{heading:"Price estimation based on your needs",subHeading:"We also provide:",listItems:["Multi-project licenses","Custom extensions","Training sessions","Integrations"],buttons:[{text:"Contact us",to:"https://www.vazco.eu/contact-us",newTab:!1}],subtitle:"Contact us to estimate your project based on business requirements."}],Ct=()=>{const[e,t]=(0,i.useState)(0);return i.createElement(he,{id:"pricing"},i.createElement(Qt,null,i.createElement(le,{level:2,size:"lg",marginBottom:24},"Pricing"),i.createElement(Rt,null,"Interested in using Forminer? Find the plan that suits you best."),i.createElement(Yt,null,Ht.map(((a,n)=>i.createElement(Nt,{key:n,current:n===e,onClick:()=>t(n)},a)))),i.createElement(Kt,qt[e])))};var Wt,Ut,Xt=a(7078),Jt=a(4965),$t=a(2425);function _t(){return _t=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t];for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},_t.apply(this,arguments)}const ea=e=>{let{title:t,titleId:a,...n}=e;return i.createElement("svg",_t({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:18,height:18,role:"img","aria-labelledby":a},n),t?i.createElement("title",{id:a},t):null,Wt||(Wt=i.createElement("path",{d:"M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"})),Ut||(Ut=i.createElement("path",{d:"M0 0h24v24H0z",fill:"none"})))},ta=o.default.div`
  max-width: 500px;
`,aa=o.default.p`
  margin: 0;
  font-weight: 500;
...
`,sa=()=>{const[e,t]=(0,i.useState)("");return i.createElement(he,{alternativeBackground:!0},i.createElement(w,null,i.createElement(b.Z,{spacing:3,container:!0},i.createElement(b.Z,{xs:12,lg:6,item:!0},i.createElement(ta,null,i.createElement(le,{level:2,size:"lg",isStrong:!0},"Frequently asked questions"))),i.createElement(b.Z,{xs:12,lg:6,item:!0},la.map(((a,n)=>{let{question:r,answer:l}=a;const o=e===`panel${n}`;return i.createElement(na,{key:`panel${n}`,expanded:o,onChange:(s=`panel${n}`,(e,a)=>{t(a?s:"")}),lastChild:la.length===n+1,square:!0},i.createElement(ra,{"aria-controls":`panel${n}d-content`},i.createElement(aa,null,r),i.createElement(ia,{isExpanded:o})),i.createElement(oa,null,Array.isArray(l)?i.createElement(Be,null,l.map((e=>{let{content:t,list:a}=e;return i.createElement(we,{key:t},t,Array.isArray(a)&&i.createElement(Be,null,a.map((e=>i.createElement(we,{key:e},e)))))}))):i.createElement("p",null,l)));var s}))))))};var ma=a(86);const ca=o.default.footer`
...
`,ga=o.default.div`
  ...
  flex-direction: column;
  align-items: center;
`,ya=[{title:"Docs",items:[{name:"Introduction",link:"/docs"},{name:"Supported technologies",link:"/docs/supported-stack"},{name:"Integration",link:"/docs/integration"}]}],Ea=()=>i.createElement(ca,null,i.createElement(w,null,i.createElement(da,null,i.createElement(ma.Z,{display:"flex",flexWrap:"wrap"},i.createElement(xa,null,i.createElement(pa,null,i.createElement("p",null,"Vazco P.S.A.",i.createElement("br",null),"Wroc\u0142aw, 50-043",i.createElement("br",null),"ul. Podwale 7/1 Poland"),i.createElement("p",null,"e."," ",i.createElement(X,{to:"mailto:hello@forminer.com",newTab:!1},"hello@forminer.com"),i.createElement("br",null),"m. +48 609 257 363"))),i.createElement(ha,null,ya.map((e=>{let{title:t,items:a}=e;return i.createElement(xa,{key:t},i.createElement(ua,null,t),a.map((e=>{let{name:t,link:a}=e;return i.createElement(ka,{key:t},i.createElement(X,{to:a,internal:!0},t))})))})))),i.createElement(ga,null,i.createElement(fa,null,`Copyright \xa9 ${(new Date).getFullYear()}`,i.createElement("a",{href:"https://www.vazco.eu/",target:"_blank",rel:"noreferrer noopener"},i.createElement("img",{src:"img/vazco-logo-2023.svg",alt:"Vazco.eu",width:"114",height:"51"}))),"All Rights Reserved")))),Aa=()=>i.createElement(i.Fragment,null,i.createElement(A,null),i.createElement(n.Z,null,i.createElement("link",{rel:"preload",href:a(3857),as:"image",type:"image/webp"})),i.createElement(r.Z,{title:"Forminer | Build Forms in React the way you need | Vazco"},i.createElement(g,null,i.createElement(te,null),i.createElement(Ae,null),i.createElement(He,null),i.createElement(lt,null),i.createElement(ct,{heading:"How can these solutions help your project?",buttonText:"Ask our CTO"}),i.createElement(Vt,null),i.createElement(Ot,null),i.createElement(Ct,null),i.createElement(jt,null),i.createElement(sa,null),i.createElement(Ea,null))))},3857:(e,t,a)=>{a.r(t),a.d(t,{default:()=>n});const n=a.p+"assets/images/Forminer-a212387a5ffa5ca39aa1e9f23884f141.webp"}}]);